...
*/
Vue.component("simple_footer_component_1721883369", {
    template: `
    <footer id="footer-section" class="flex-1 bg-white dark:bg-gray-800">
            <nav class="bg-white border-gray-200 dark:bg-gray-900">
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <a href="#" class="flex items-center">
                        <img src="./images/logo.svg" class="h-8 mr-3" alt="ProductScope Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">ProductScope</span>
                    </a>
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Discover the latest and greatest products on the market. Stay ahead of the curve with our cutting-edge product finder app.
                    </div>
                </div>
            </div>
        </footer> 
